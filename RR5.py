#######################################################################################################
# Round-Robin with Time Slice = 5 Algorithm Implementation
# ------------------------------------------------------------------------
# Mark Barros
...
class Job:
    ...
    initialBurstTime = 0 # (equals the value in the job.txt)
...
# This is a constant. ---------------------------------------------------------------------------------
SLICE = 5 # This is the Round-Robin time quantum.
...
def outputHeader():
    ...
    print("#########################################################################################")
    print()
    print("Round-Robin with Time Slice = 5 Algorithm Implementation - By Mark Barros")
    print()
...
def outputAverageTurnAroundTime():
    print(calculateAverageTurnaroundTime(), "milliseconds.")
...
def rr5():
    ...
    # Process all of the jobs in a Round-Robin fashion using a time quantum of five.
	...
	# Output the average Turnaroud Time.
    outputAverageTurnAroundTime()

# End of RoundRobinFive Module ########################################################################